...
export const messages: Record<string, string> = {
  ...
  'cmd.cot.usage': 'Usage: /cot (status) | /cot off (mute this chat) | /cot on (restore)',
  'help.cot': '/cot        - Thinking-process message switch (this chat): /cot off to mute, /cot on to restore, /cot for status (bot-level master switch: /botconfig thinkingCard)',
